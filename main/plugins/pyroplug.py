...
async def send_video_with_chat_id(client, sender, path, caption, duration, hi, wi, thumb_path, upm):
    ...
    try:
        await client.send_video(
            ...
            progress_args=(
                client,
                '**__Uploading: [💖 KANHA KUWAL 💕](https://t.me/Sonickuwalupdate)__**\n ',
                upm,
                time.time()
            )
        )
...
async def send_document_with_chat_id(client, sender, path, caption, thumb_path, upm):
    ...
    try:
        await client.send_document(
            ...
            progress_args=(
                client,
                '**__Uploading:__**\n**__Bot made by [💖 KANHA KUWAL 💕](https://t.me/Sonickuwalupdate)__**',
                upm,
                time.time()
            )
        )
        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[💖 KANHA KUWAL 💕](https://t.me/Sonickuwalupdate)__**\n ",
                    edit,
                    time.time()
                )
            )  
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[💖 KANHA KUWAL 💕](https://t.me/Sonickuwalupdate)**__" if msg.caption else "__Unrestricted by **[💖 KANHA KUWAL 💕](https://t.me/Sonickuwalupdate)**__"
